 ...
 * the License.
 */
package org.bk.dataflow.bq.util;
...
public class ValueProviderUtils {
  ...
  public static <T> ValueProvider<T> eitherOrValueProvider(
    ...
    return DualInputNestedValueProvider.of(
        optionalParameter,
        defaultParameter,
        new SerializableFunction<DualInputNestedValueProvider.TranslatorInput<T, T>, T>() {
          @Override
          public T apply(DualInputNestedValueProvider.TranslatorInput<T, T> input) {
